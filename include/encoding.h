...
#define CAUSE_USER_TIMER_INTERRUPT 4
#define CAUSE_SUPERVISOR_TIMER_INTERRUPT 5
#define CAUSE_HYPERVISOR_TIMER_INTERRUPT 6
#define CAUSE_MACHINE_TIMER_INTERRUPT 7
#define CAUSE_USER_EXTERNAL_INTERRUPT 8
#define CAUSE_SUPERVISOR_EXTERNAL_INTERRUPT 9
#define CAUSE_HYPERVISOR_EXTERNAL_INTERRUPT 10
